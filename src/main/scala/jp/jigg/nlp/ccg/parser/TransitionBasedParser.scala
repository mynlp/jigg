...
import jp.jigg.nlp.ccg.lexicon.{PoS, Word, Category, CandAssignedSentence, AppliedRule, TrainSentence, Derivation}
import jp.jigg.ml.{Perceptron, FeatureIndexer, Example}
