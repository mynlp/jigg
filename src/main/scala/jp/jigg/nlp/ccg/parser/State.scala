package jp.jigg.nlp.ccg.parser

import jp.jigg.nlp.ccg.lexicon.{Category, Point, Derivation}
import jp.jigg.nlp.ccg.lexicon.Direction._
...
case class FullState(private val stack:Array[StackedNode],
  ...
  override def toDerivation: Derivation = {
    import jp.jigg.nlp.ccg.lexicon.{NoneChildPoint, UnaryChildPoint, BinaryChildrenPoints, Point, ChildPoint, AppliedRule}
