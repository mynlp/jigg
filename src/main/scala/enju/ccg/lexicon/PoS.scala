 ...
 * To enable using these different types of tags transparently (it is useful in e.g., feature extractions), Conjugation or FineTag itself are PoS.
 ...
 *
 * TODO: refacotor this class same as in Category classes to assign ids after once instantiating; this make using of this class more safe.
 */
