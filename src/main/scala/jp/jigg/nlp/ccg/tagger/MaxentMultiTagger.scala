package jp.jigg.nlp.ccg.tagger

import jp.jigg.nlp.ccg.lexicon._
//import jp.jigg.nlp.ccg.util.Indexer
import jp.jigg.ml.{LogLinearClassifier, OnlineLogLinearTrainer, Example, FeatureIndexer}
